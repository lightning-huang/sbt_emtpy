...
spark2-submit --archives $HANLP_DATA_ARCHIVE --jars $DEPENDENT_JARS --class $MAIN_CLASS --name BJ_AI_WORD2VEC --files $WORKING_DIR_FILES --queue $AI_QUEUE_NAME --driver-memory 2G --executor-memory 2G train_model.jar