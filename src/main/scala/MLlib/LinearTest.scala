...
object LinearTest {
  def main(args: Array[String]): Unit = {
    ...
    val training = spark.createDataFrame(Seq(
      ...
      (5.601801561245534, Vectors.dense(Array(0.6949189734965766, -0.32697929564739403, -0.15359663581829275, -0.8951865090520432, 0.2057889391931318, -0.6676656789571533, -0.03553655732400762, 0.14550349954571096, 0.034600542078191854, 0.4223352065067103))),
